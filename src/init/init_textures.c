...
int init_textures(world_t *wd)
{
	...
	wd->textures[4] = sfTexture_createFromFile("assets/increase.png", NULL);
	wd->textures[5] = sfTexture_createFromFile("assets/low_force.png", NULL);
	wd->textures[6] = sfTexture_createFromFile("assets/high_force.png", NULL);
